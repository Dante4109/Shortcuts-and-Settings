...
### Copy and paste code below to install extensions on new VS Code install.
...
code --install-extension rolandostar.tabletopsimulator-lua
code --install-extension rvest.vs-code-prettier-eslint
code --install-extension sas.sas-lsp
